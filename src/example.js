...
export const horizontalNodes = ([
  <div className="example-node" key="0" data-caption="This i the caption 1">
    <div className="example-node__image" />
    <h3 className="example-node__title">Work for us: Nico Colchester journalism fellowshiphs</h3>
    <h4 className="example-node__subtitle" data-caption="This i the caption">Europe | 1 hour 44 mins ago</h4>
  </div>,
  <div className="example-node" key="1" data-caption="This i the caption 2">
    <div className="example-node__image" />
    <h3 className="example-node__title">The Economist explains: What happened in the Thirty Years Wat?</h3>
    <h4 className="example-node__subtitle" data-caption="This i the caption">The Economist explains | 1 day ago</h4>
  </div>,
  <div className="example-node" key="2" data-caption="This i the caption 3">
    <div className="example-node__image" />
    ...
    <h4 className="example-node__subtitle" data-caption="This i the caption 4">The Economist explains | 2 days ago</h4>
  </div>,
  <div className="example-node" key="3" data-caption="This i the caption 5">
    <div className="example-node__image" />
    <h3 className="example-node__title">
      Catalonian independence: Catalonia's new president is even more secessionist than the last
    </h3>
    <h4 className="example-node__subtitle" data-caption="This i the caption">Europe | 2 days ago</h4>
  </div>,
  <div className="example-node" key="4" data-caption="This i the caption 6">
    <div className="example-node__image" />
    <h3 className="example-node__title">Work for us: Nico Colchester journalism fellowshiphs</h3>
